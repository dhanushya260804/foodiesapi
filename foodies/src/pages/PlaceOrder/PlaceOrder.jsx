              ...
              <form className="needs-validation" onSubmit={onSubmitHandler}>
                <div className="row g-3">
                  ...
                  <div className="col-md-5">
                    ...
                    <select className="form-select" id="country" required name="state" value={data.state} onChange={onChangeHandler}>
                  ...
                  <div className="col-md-4">
                    ...
                    <select className="form-select" id="state" required name="city" value={data.city} onChange={onChangeHandler}>
                      <option value="">Choose...</option>
